  ...
  return (
    <section className="w-full py-8 md:py-16">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-center font-h3 text-2xl md:text-[42px] leading-[140%] tracking-[0] mb-12 md:mb-24">
        ...
        <div className="relative w-full max-w-[760px] h-[250px] md:h-[411px] mx-auto">
